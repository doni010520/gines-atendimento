 ...
 * Só grava o payload cru em app_logs. Uso: validar o formato real do payload de leads
 * de tráfego (referral do anúncio) num número novo antes de ligar o bot nele de verdade.
 */
